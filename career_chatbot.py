...
class Evaluator:
    ...
    def __init__(self, config: ChatbotConfig, context: Dict[str, str], openai_client: OpenAI):
        self.config = config
        self.context = context
        # Use the same OpenAI client for evaluation
        self.evaluator_client = openai_client
...
class ToolRegistry:
    ...
    def _create_tool_definitions(self) -> List[Dict]:
        ...
        evaluate_job_match = {
            ...
            "strict": True,
            "description": (
                "Analyze how well the candidate matches a SPECIFIC JOB POSTING or job description. "
                "Use this ONLY when someone provides a complete job description, job posting, or asks "
                "about job fit for a specific role. Do NOT use this for general GitHub or technical questions. "
...
class CareerChatbot:
    ...
    def __init__(self, config: ChatbotConfig):
        ...
        self.evaluator = Evaluator(self.config, self.context, self.openai_client)
